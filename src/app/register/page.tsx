      ...
      <div className="z-10 w-full max-w-md px-4">
        <div className="w-full max-w-md p-8 space-y-6 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-white">Sign Up Coming Soon</h1>
            <p className="text-white/60 mt-2">Account creation is currently being rebuilt.</p>
          </div>
          
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="text-white block">First Name</label>
                <Input 
                  type="text" 
                  placeholder="John" 
              ...
              <div className="space-y-2">
                <label className="text-white block">Last Name</label>
                <Input 
                  type="text" 
                  placeholder="Doe" 
                  className="bg-white/5 border-white/10 text-white placeholder-white/60"
